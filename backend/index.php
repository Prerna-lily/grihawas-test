                            ...
                            <form method="post" name="customerData" action="ccavRequestHandler.php">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="hidden">
                                            <td>Redirect URL:</td>
                                            <td><input type="text" class="form-control" name="redirect_url" value="https://localhost/ccavenue/ccavResponseHandler.php"/></td>
                                        </tr>
                                        <tr class="hidden">
                                            <td>Cancel URL:</td>
                                            <td><input type="text" class="form-control" name="cancel_url" value="https://localhost/ccavenue/ccavResponseHandler.php"/></td>
                                        </tr>
                                        <tr class="hidden">
                                            <td>Language:</td>
